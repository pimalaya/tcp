# Stream flows [![Documentation](https://img.shields.io/docsrs/stream-flows)](https://docs.rs/stream-flows/latest/stream_flows/) [![Matrix](https://img.shields.io/matrix/pimalaya:matrix.org?color=success&label=chat)](https://matrix.to/#/#pimalaya:matrix.org)
...
*See available handlers at [./src/handlers](https://github.com/pimalaya/stream/tree/master/src/handlers).*
...
*See complete examples at [./examples](https://github.com/pimalaya/stream/blob/master/examples).*
...
- [starttls-flows](https://github.com/pimalaya/starttls)
