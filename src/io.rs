/// The stream I/O request enum, emitted by flows and processed by
/// handlers.
///
/// This enum represents all the possible I/O requests that a stream
...
pub enum Io {
    ...
    ///
    /// [state buffer]: crate::State::get_write_buffer
    /// [how many bytes]: crate::State::set_written_bytes_count
    Write,
}
